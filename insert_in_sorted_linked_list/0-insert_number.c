...
/**
 * find_insertion_point - Trouve le point d'insertion pour un nouveau noeud dans une liste chaînée triée
 * @head: Pointeur vers la tête de la liste chaînée
 * @number: La valeur à insérer dans le nouveau noeud
 * Return: un double pointeur vers le nœud précédent où le nouveau nœud doit être inséré
 */
...
/**
 * insert_node_at_point - Insère un nouveau noeud dans une liste chaînée à l'emplacement spécifié
 * @insertion_point: Double pointeur vers le nœud précédent où le nouveau nœud doit être inséré
